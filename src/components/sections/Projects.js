                    ...
                    <div className="p-6">
                        <div className="mb-3">
                            ...
                            <p className="text-gray-300 text-base mb-4 leading-relaxed">
                                A full-stack web application that allows users to write, edit, search, and read articles through a clean and
                                minimal UI.
                            </p>
                        </div>
                        ...
                        <div className="flex gap-3 mb-4">
                            <Link href="https://wryte-7qlc.onrender.com/" target="_blank" rel="noopener noreferrer">
                            ...
                            <Link href="https://github.com/rajsahu08/Wryte" target="_blank" rel="noopener noreferrer">
